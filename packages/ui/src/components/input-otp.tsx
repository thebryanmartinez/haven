...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useFocusableInteractive: decorative separator, not an interactive slider
    // biome-ignore lint/a11y/useSemanticElements: <hr> cannot contain the Dot icon
    // biome-ignore lint/a11y/useAriaPropsForRole: not a slider separator, aria-valuenow does not apply
